/**
 * Assign the 50 heat-pump datasheets/manuals researched for the ERA check HH
 * weight audit to their matching Strapi entries (by exact artNr).
 *
 * Source folder: C:/Users/mguerel/Documents/Waermepumpen-Gewichte/datenblaetter
 * Each file is named "<artNr>.pdf". Content-identical files (e.g. the same
 * Zodiac range manual copied under several model artNrs) are uploaded once
 * and reused, same as scripts/assign-docs-bulk.mjs.
 *
 * Usage:
 *   node scripts/assign-waermepumpen-docs.mjs [--dry-run]
 */
...
const ROOT = "C:/Users/mguerel/Documents/Waermepumpen-Gewichte/datenblaetter";
const CACHE_PATH = new URL("../../Waermepumpen-Gewichte/ergebnis/.assign-cache.json", import.meta.url);

const DRY_RUN = process.argv.includes("--dry-run");

// artNr -> docType (title shown in the product's docs list)
const DOC_TYPE_PROSPEKT   = "Prospekte";
const DOC_TYPE_ANLEITUNG  = "Bedienungsanleitungen - Einbauanleitungen - Anschlussanleitungen";

const ARTNRS = {
  "11321":       DOC_TYPE_PROSPEKT,
  "454071":      DOC_TYPE_ANLEITUNG,
  "454072":      DOC_TYPE_ANLEITUNG,
  "454073":      DOC_TYPE_ANLEITUNG,
  "454074":      DOC_TYPE_ANLEITUNG,
  "454075":      DOC_TYPE_ANLEITUNG,
  "475337":      DOC_TYPE_ANLEITUNG,
  "475338":      DOC_TYPE_ANLEITUNG,
  "WH000587":    DOC_TYPE_ANLEITUNG,
  "WH000588":    DOC_TYPE_ANLEITUNG,
  "WH000589":    DOC_TYPE_ANLEITUNG,
  "WH000590":    DOC_TYPE_ANLEITUNG,
  "WH000591":    DOC_TYPE_ANLEITUNG,
  "WH000593":    DOC_TYPE_ANLEITUNG,
  "WH000595":    DOC_TYPE_ANLEITUNG,
  "WH000592":    DOC_TYPE_ANLEITUNG,
  "WH000594":    DOC_TYPE_ANLEITUNG,
  "WH000596":    DOC_TYPE_ANLEITUNG,
  "WH000609":    DOC_TYPE_ANLEITUNG,
  "WH000610":    DOC_TYPE_ANLEITUNG,
  "WH000611":    DOC_TYPE_ANLEITUNG,
  "WH000612":    DOC_TYPE_ANLEITUNG,
  "WH000519":    DOC_TYPE_ANLEITUNG,
  "WH000520":    DOC_TYPE_ANLEITUNG,
  "WH000521":    DOC_TYPE_ANLEITUNG,
  "WH000522":    DOC_TYPE_ANLEITUNG,
  "WH000523":    DOC_TYPE_ANLEITUNG,
  "WH000382":    DOC_TYPE_ANLEITUNG,
  "WH000383":    DOC_TYPE_ANLEITUNG,
  "WH000456":    DOC_TYPE_ANLEITUNG,
  "WH000458":    DOC_TYPE_ANLEITUNG,
  "WH000460":    DOC_TYPE_ANLEITUNG,
  "WH000462":    DOC_TYPE_ANLEITUNG,
  "WH000464":    DOC_TYPE_ANLEITUNG,
  "WH000577":    DOC_TYPE_ANLEITUNG,
  "WH000578":    DOC_TYPE_ANLEITUNG,
  "WH000579":    DOC_TYPE_ANLEITUNG,
  "WH000580":    DOC_TYPE_ANLEITUNG,
  "WH000581":    DOC_TYPE_ANLEITUNG,
  "WH000583":    DOC_TYPE_ANLEITUNG,
  "WH000585":    DOC_TYPE_ANLEITUNG,
  "WH000582":    DOC_TYPE_ANLEITUNG,
  "WH000584":    DOC_TYPE_ANLEITUNG,
  "WH000586":    DOC_TYPE_ANLEITUNG,
  "WH000613":    DOC_TYPE_ANLEITUNG,
  "WH000614":    DOC_TYPE_ANLEITUNG,
  "WH000615":    DOC_TYPE_ANLEITUNG,
  "WH000616":    DOC_TYPE_ANLEITUNG,
  "W20PFORCE25": DOC_TYPE_ANLEITUNG,
  "W20PFORCE35": DOC_TYPE_ANLEITUNG,
};
